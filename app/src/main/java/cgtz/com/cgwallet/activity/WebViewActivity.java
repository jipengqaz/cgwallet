...
//        public MyJavaScriptInterface(Activity at){
//            this.activity = at;
//        }
...
//                super.handleMessage(msg);
//                try {
//                    UtilityUtils.dimiss(activity, pd);
//                    UtilityUtils.isSuccess(activity,msg.obj,false);
...
//         */
//        public void callJs(){
//            webView.loadUrl("javascript:CgtzAppActGetReward('" + UtilityUtils.getUserId()+
//                    "','" + UtilityUtils.getUserToken() + "','android-"+Constants.version+"')");
//        }
